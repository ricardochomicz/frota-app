    ...
    <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 sm:col-span-2">
            <div className="mb-4">
                ...
                <input type="text" value={tire.mileage_at_maintenance} className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readOnly />
            </div>
        </div>
        <div className="col-span-12 sm:col-span-2">
            <div className="mb-4">
