...
import { faEdit, faTrash, faTimes, faFilter, faBroom, faBell } from '@fortawesome/free-solid-svg-icons';
import { InputMask } from '@react-input/mask';
import { format } from 'date-fns';
import { badgeStatus } from "../../helpers/Helpers";
                                    ...
                                    {maintenances.map((maintenance) => (
                                        ...
                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200" key={maintenance.id}>
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                {badgeStatus(maintenance.status)}
                                            </td>
                                            ...
                                            <td className="px-1 py-4 text-center">
                                                {Number(maintenance.tires_pending) > 0 && (
                                                    <FontAwesomeIcon icon={faBell} size="lg" className="text-yellow-500 animate-bounce me-2" title="Pneus para revisão!" />
                                                )}
                                            </td>
                                        </tr>
                                    ))}
