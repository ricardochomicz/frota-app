...
function FormTires({ handleSubmit, buttonText, register, errors, isSubmitting, isCreate, textForm, handleStatusChange }) {
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                    <div className="col-span-12 sm:col-span-3">
                        <div>
                            ...
                            <input type="text" name='code' {...register('code')} className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    ...
                    <div className="flex flex-row space-x-4">
                        <div className="flex-1">
                            <div>
                                ...
                                <input type="text" name="brand" {...register('brand')} className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
